...
export const myProjects = [
  ...
  },
  {
    ...
    desc: 'A sophisticated AI chat application built with Next.js — real-time conversations, advanced prompt caching, and intelligent tool orchestration powered by LangChain and Claude 3.5 Sonnet.',
    metrics: [
  ...
  },
  {
    ...
    desc: 'A SaaS platform that lets users create stunning photo manipulations using AI — image restoration, recolor, object removal, generative fill, background removal — paired with a credits model, Stripe payments and auth.',
    metrics: [
